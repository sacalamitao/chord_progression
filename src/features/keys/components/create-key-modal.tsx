...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.textSecondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.8 },
  title: { color: colors.textPrimary, fontSize: 26, fontWeight: '900', marginTop: 2 },
  ...
  closeButtonText: { color: colors.textPrimary, fontSize: 26, lineHeight: 28, fontWeight: '300' },
  ...
  input: { minHeight: 44, borderRadius: 10, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surfaceElevated, color: colors.textPrimary, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, fontWeight: '600' },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  degreeItem: { width: '48%' },
  degreeLabel: { color: colors.textSecondary, fontSize: 11, fontWeight: '700', marginBottom: 5 },
  errorText: { color: colors.danger, fontSize: 13, fontWeight: '700', marginTop: 12 },
  ...
  primaryButtonText: { color: colors.textPrimary, fontSize: 14, fontWeight: '800' },
